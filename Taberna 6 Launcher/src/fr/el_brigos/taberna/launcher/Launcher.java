...
public class Launcher {
	...
	public static final GameVersion TA_VERSION = new GameVersion("1.15.2", GameType.V1_13_HIGER_FORGE.setNewForgeVersionDiscriminator(new NewForgeVersionDiscriminator("31.2.46", "1.15.2", "net.minecraftforge", "20200515.085601")));
	public static final GameInfos TA_INFOS = new GameInfos("Taberna6", TA_VERSION, new GameTweak[] {});
	...
	public static void update() throws Exception {
		SUpdate su = new SUpdate("http://taberna6.el-taberna.com/taberna-launcher", TA_DIR);
