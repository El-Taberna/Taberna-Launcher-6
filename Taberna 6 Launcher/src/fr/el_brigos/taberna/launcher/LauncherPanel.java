...
public class LauncherPanel extends JPanel implements SwingerEventListener {
	...
	private Image background = getResource("background_test.jpg");
	...
	private STexturedButton quitButton = new STexturedButton(getResource("exit.png"));
	...
	private JLabel infoLabel = new JLabel("Bienvenue sur le Taberna 6 Launcher Alpha !", SwingConstants.CENTER);
	...
	public LauncherPanel() {
		...
		usernameField.setBounds(100, 232, 218, 38);
		this.add(usernameField);

		passwordField.setOpaque(false);
		passwordField.setBorder(null);
		passwordField.setFont(usernameField.getFont());
		passwordField.setBounds(100, 287, 218, 37);
		this.add(passwordField);
		
		playButton.setBounds(75, 403, 225, 45);
		playButton.addEventListener(this);
		this.add(playButton);
		
		quitButton.setBounds(347, 0, 28, 30);
		quitButton.addEventListener(this);
		this.add(quitButton);
		
		hideButton.setBounds(300, 10, 32, 14);
		hideButton.addEventListener(this);
		this.add(hideButton);
		
		ramButton.setBounds(0, 0, 30, 30);
		ramButton.addEventListener(this);
		this.add(ramButton);
		
		progressBar.setBounds(25, 510, 325, 20);
		progressBar.setVisible(true);
		add(progressBar);
		
		infoLabel.setForeground(Color.WHITE);
		infoLabel.setFont(usernameField.getFont());
		infoLabel.setBounds(25, 510, 325, 20);
		add(infoLabel);
	}
